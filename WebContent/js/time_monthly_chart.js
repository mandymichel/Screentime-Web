$(document).ready(
		function() {
			console.log('hi');
			var myData = new Array([ 'Jan', 2 ], [ 'Feb', 1 ], [ 'Mar', 3 ], [
					'Apr', 6 ], [ 'May', 8 ], [ 'Jun', 10 ], [ 'Jul', 9 ], [
					'Aug', 8 ], [ 'Sep', 5 ], [ 'Oct', 6 ], [ 'Nov', 2 ], [
					'Dec', 4 ]);
			var colors = [ '#CE0000', '#EF2323', '#D20202', '#A70000',
					'#850000', '#740000', '#530000', '#850000', '#B00000',
